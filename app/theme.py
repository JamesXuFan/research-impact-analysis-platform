...
# Shared browser-tab icon — pass as `st.set_page_config(page_icon=theme.FAVICON)`
# on every page, instead of a per-page emoji, so every tab reads as this one
# project (COMP3888_W11_02_P36) at a glance when several are open. Generated by
# app/generate_favicon.py; regenerate there, don't hand-edit the PNG.
